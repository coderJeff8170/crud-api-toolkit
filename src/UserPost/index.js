...
import { fetchPost, deletePost, setEdit, updatePost } from '../redux/features/postSlice';
...
const Home = () => {
    ...
    }, [body]); //only call if body changes

    const fetchUserPost = () => {
        if (!id) {
            window.alert('please provide an id before proceeding!');
        } else {
